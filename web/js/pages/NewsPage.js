    ...
    return (
      <div className='page'>
        <VerticalLayout>
          ...
          <VerticalLayoutItem>
            <ScrollableNav>
              <ScrollableNavItem name={intlData.messages.NAV_LatestNews}>
                <TabStrip
              ...
              <ScrollableNavItem name={intlData.messages.NAV_RecentDeals}>
                <Section>
                  <SectionTitle text={intlData.messages.NAV_RecentDeals} />
                  <SectionContent>
                    <Paragraph source={contextPath + 'road/socialResponsibility'} />
                  </SectionContent>
                </Section>
